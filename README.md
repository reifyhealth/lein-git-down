...
Add any feature requests as GitHub issues. We can't guarantee that we will implement all features, but we love getting new ideas for ways our plugin can solve problems!
